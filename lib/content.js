...
export const NAME = 'Wendell Nascimento Dourado';
...
const copy = {
  pt: {
    ...
    lead: 'Desenvolvedor pleno na Consumidor Positivo, focado em backend: GoLang, AWS, Serverless e Kubernetes.',
    about1:
      'Tenho 23 anos e programo desde os 15, quando descobri a área no curso técnico do CEAP. Entrei na Red Ventures como estagiário em 2020 e hoje trabalho no sistema de autenticação da Consumidor Positivo.',
    about2:
  ...
  en: {
    ...
    about1:
      "I'm 23 and have been coding since 15, when I found the field in CEAP's technical course. I joined Red Ventures as an intern in 2020 and now work on the authentication system at Consumidor Positivo.",
    about2:
  ...
  pt: [
    {
      ...
      text: 'O iq foi vendido pela Red Ventures e renomeado Consumidor Positivo. Trabalho no sistema de autenticação.',
      tags: [
        'GoLang',
        'AWS',
        'Serverless',
    ...
    },
    {
      ...
      roles: [
        ...
        { title: 'Intern', period: 'ago 2020 – dez 2020 · 5 meses' },
      ],
  ...
  en: [
    {
      ...
      text: 'iq was sold by Red Ventures and renamed Consumidor Positivo. I work on the authentication system.',
      tags: [
        'GoLang',
        'AWS',
        'Serverless',
